...
public class AddFile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("name = " + filePart.getSubmittedFileName());
        ...
        int count = db.addFile(user_id, filePart.getSubmittedFileName(), (int)filePart.getSize(), filePart.getInputStream());
        if(count > 0)
        {
             System.out.println("Successful addition of file ");
        }
        RequestDispatcher rd = request.getRequestDispatcher("file.jsp");
        rd.forward(request, response);
    }
